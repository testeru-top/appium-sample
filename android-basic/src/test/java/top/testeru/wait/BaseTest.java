...
public class BaseTest {
    ...
    public static void start() throws MalformedURLException {
        ...
        /**
         * driver 当前的driver
         * Duration.ofSeconds(20)  显示等待的总时间
         * Duration.ofSeconds(2)   每隔多久就去找一下对应的显示等待的条件
         */
        webDriverWait = new WebDriverWait(driver, Duration.ofSeconds(20), Duration.ofSeconds(2));
    }
}
